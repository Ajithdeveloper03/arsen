    ...
    return (
        <div className="flex min-h-screen bg-[#F1F5F9] font-sans selection:bg-[#DFA45B] selection:text-[#022C22]">
            ...
            <div className="flex-1 max-h-screen overflow-y-auto relative scroll-smooth bg-slate-50 flex flex-col">
                ...
                <main className="relative z-10 p-2 sm:p-4 md:p-6 lg:p-8 max-w-[1600px] mx-auto min-h-screen w-full">
                    {/* Use Outlet to render child routes */}
                    <div className="bg-white rounded-xl sm:rounded-3xl p-2.5 sm:p-4 md:p-6 lg:p-8 shadow-sm border border-slate-200 min-h-[calc(100vh-6rem)]">
                        <Outlet />
                    </div>
                </main>
            </div>
