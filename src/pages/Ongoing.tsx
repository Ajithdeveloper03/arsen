...
const PROJECTS = [
  {
    ...
    progress: 88,
    location: "Chennai",
    img: "https://amazingarchitecture.com/storage/1529/n_cube_villa_cubism_architects_and_interiors_india.jpg",
  },
  {
    id: 2,
    title: "Bluestone Pinnacle",
    progress: 62,
    location: "Coimbatore",
    img: "https://res.cloudinary.com/jerrick/image/upload/d_642250b563292b35f27461a7.png,f_jpg,fl_progressive,q_auto,w_1024/640eff394904ce001dea70b8.jpg",
  },
  {
    id: 3,
    title: "Verdant Horizon Towers",
    progress: 45,
    location: "Madurai",
    img: "https://i.ytimg.com/vi/YcIzjBrbRqg/maxresdefault.jpg",
  },
  {
    id: 4,
    title: "Eco Harmony Residences",
    progress: 95,
    location: "Tiruchirappalli",
    img: "https://cdn.buildofy.com/projects/1809e23e-c606-43ce-a215-c6d42c03002f.jpeg",
  },
];
  ...
  return (
    <div className="bg-black min-h-screen text-white font-sans overflow-x-hidden selection:bg-[#c9a050] selection:text-black">
      ...
      <section className="relative h-[100svh] w-full flex items-center justify-center overflow-hidden">
        ...
        >
          <span className="text-[8px] md:text-[10px] font-black tracking-[0.6em] md:tracking-[1em] text-[#c9a050] uppercase block mb-4 md:mb-8">
            Ongoing Biophilic Ventures
          </span>
          ...
          <p className="mt-6 text-white/60 text-xs md:text-base font-medium uppercase tracking-[0.2em] md:tracking-widest max-w-lg mx-auto leading-relaxed">
      ...
      <section className="relative">
        <AnimatePresence>
          {PROJECTS.map((project, index) => (
            ...
            >
              {/* Background with responsive Ken Burns effect */}
              <motion.img 
                src={project.img}
                alt={project.title}
              ...
              <div className="relative z-10 w-full max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10 lg:gap-20 items-center">
                ...
                >
                  <div className="flex items-center justify-center md:justify-start gap-3 text-[#c9a050]">
                    <Globe size={18} />
                    <span className="text-xs md:text-sm font-black uppercase tracking-widest">{project.location}, TN</span>
                  </div>
                  <h3 className="text-4xl md:text-6xl lg:text-7xl font-black uppercase tracking-tighter italic leading-none">
                    {project.title}
                  </h3>
                  <p className="text-white/60 text-sm md:text-lg leading-relaxed max-w-md mx-auto md:mx-0">
                    Integrating nature with modern luxury, currently at {project.progress}% completion in the heart of {project.location}.
                  </p>
                  <button className="flex items-center gap-3 text-[#c9a050] hover:text-white transition-colors mx-auto md:mx-0">
                    <span className="text-[10px] md:text-xs font-black uppercase tracking-[0.2em]">Monitor Progress</span>
                ...
                >
                  ...
                  <div className="flex items-center gap-3 text-[#c9a050]/80">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest">Live Site Data</span>
                  </div>
                </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-4">
            {[
              ...
              <div key={i} className="space-y-1">
                ...
                <span className="text-[8px] md:text-[10px] font-black uppercase tracking-[0.2em] text-white/40 block">{stat.label}</span>
              </div>
            ))}
          </div>
