...
class CmsDataSeeder extends Seeder
{
    public function run()
    {
        ...
        $contacts = [
            ...
            ['type' => 'map', 'label' => 'Head Office', 'value' => '#4, Noombal Road, Velappanchavadi Chennai – 600 077.', 'icon' => 'MapPin', 'order_index' => 4],
            ['type' => 'map', 'label' => 'Factory', 'value' => 'No.211/1B, Metro city phase 1, Rajankuppam, Ayanambakkam, Chennai - 600095', 'icon' => 'Factory', 'order_index' => 5],
